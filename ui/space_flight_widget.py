...
class SpaceFlightWidget(QWidget):
    ...
    def _ensure_final_positions(self) -> None:
        try:
            ...
            record_error(
                module="space_flight_widget",
                function="_ensure_final_positions",
                line=0,
                error_type=type(exc).__name__,
                message=str(exc),
                severity="warning",
    ...
    def _build_glyph_tendrils(self) -> None:
        ...
        try:
            ...
            record_error(
                module="space_flight_widget",
                function="_build_glyph_tendrils",
                line=0,
                error_type=type(exc).__name__,
                message=str(exc),
                severity="warning",
